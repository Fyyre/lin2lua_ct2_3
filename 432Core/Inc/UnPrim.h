...
public:
	...
	virtual INT PointCheck(struct FCheckResult &, class AActor *, class FVector const &, class FVector const &, DWORD);
	virtual INT LineCheck(struct FCheckResult &, class AActor *, class FVector const &, class FVector const &, class FVector const &, DWORD, DWORD);
	...
	UPrimitive();
	static void * CDECL operator new(unsigned int, class UObject *, TCHAR *, DWORD);
	static void * CDECL operator new(unsigned int, class UObject *, TCHAR const *, DWORD);
